...
export function init_sprites() {
  ...
  PALS = {
    player: ['transparent','#221716','#543324','#986550','#e8c040','#d4c896','#151216','#332024'],
    player_high: ['transparent','#5a4020','#a07020','#e8c040','#fff0a0','#fff8d0','#3a2810','#7a5020'],
    tony: ['transparent','#15060d','#30121e','#4f2024','#792e3d','#d4c896','#542624','#000'],
    yuri: ['transparent','#150c0f','#41201d','#792e1d','#d4c896','#e8c040','#4f261d','#000'],
    brutus: ['transparent','#000','#331a1d','#542624','#986550','#15060d','#d4c896','#79261d'],
    pete: ['transparent','#150c0f','#41332c','#836550','#d4c896','#543324','#987a41','#000'],
    lurch: ['transparent','#150616','#331a33','#543342','#986560','#d4c896','#221216','#d4c896'],
    sherri: ['transparent','#15060f','#301225','#542633','#984850','#d4c896','#D488D4','#000'],
    paulie: ['transparent','#15060f','#4f2633','#834850','#D4A880','#d4c896','#542624','#000'],
    dave: ['transparent','#150c0f','#33201d','#543324','#986550','#d4c896','#815c3b','#000'],
    mom: ['transparent','#150616','#462642','#7a9050','#A8C030','#d4c896','#D488D4','#d4c896'],
    possum: ['transparent','#15060d','#332024','#543333','#987a68','#d4c896','#e8c040','#986521'],
    priest: ['transparent','#000','#150c25','#221833','#412642','#d4c896','#D488D4','#d4c896'],
    priest_fallen: ['transparent','#04020d','#12081e','#290f3a','#4f1a5f','#d4c896','#792e77','#e8c040'],
    conductor: ['transparent','#150c16','#332024','#543333','#986550','#d4c896','#792e3d','#543333'],
    larry: ['transparent','#15060f','#30121e','#792633','#d4c896','#e8c040','#c65631','#d4c896'],
    stripe: ['transparent','#08071e','#15122c','#332d4a','#746c87','#d4c896','#e8c040','#D4D4D4'],
    pigeon: ['transparent','#151216','#332d2c','#5b4f41','#817370','#d4c896','#c65631','#e8c040'],
    cop: ['transparent','#000','#080820','#1818a0','#2828d0','#d4c896','#e8c040','#d4c896'],
    biggu: ['transparent','#150c0f','#33201d','#543333','#987360','#d4c896','#543324','#000'],
    horsecop: ['transparent','#000','#080820','#1818a0','#2828d0','#d4c896','#604030','#d4c896'],
    vapelord: ['transparent','#150625','#301250','#54267e','#9848be','#d4c896','#D488D4','#d4c896'],
    mayorscousin: ['transparent','#150c0f','#33201d','#543333','#986550','#d4c896','#792e3d','#d4c896'],
    phoneguy: ['transparent','#150c0f','#33201d','#543333','#986550','#d4c896','#88C0FF','#d4c896'],
    pothole: ['transparent','#000','#08060d','#151216','#25201d','#332d2c','#543324','#d4c896'],
    launderlady: ['transparent','#150625','#332e46','#5b5170','#A09ABD','#d4c896','#88C0FF','#d4c896'],
    metermaid: ['transparent','#151216','#332d1d','#54462c','#A8C030','#d4c896','#792e3d','#d4c896'],
    foodtruck: ['transparent','#15060d','#301216','#542624','#984131','#d4c896','#c65631','#d4c896'],
    priestson: ['transparent','#150625','#221833','#412642','#7a6589','#d4c896','#88C0FF','#d4c896'],
    karaoke: ['transparent','#150625','#301250','#54267e','#9848be','#d4c896','#e8c040','#d4c896'],
    // v13 wave 2 — converting the last four emoji-era styles and giving barb her own skin
    cubscout: ['transparent','#151216','#2320a4','#E8C0A0','#25402c','#e8c040','#1a182e','#d4c896'],
    jogger: ['transparent','#150616','#C8A850','#F0C8B0','#D488D4','#F8A8C8','#151325','#d4c896'],
    busker: ['transparent','#150c0f','#4f261d','#D4A878','#835e41','#543333','#232d4a','#d4c896'],
    dogwalker: ['transparent','#150c16','#543324','#E8C8A8','#E8A880','#88C0FF','#413a4a','#d4c896'],
    barb: ['transparent','#1a122e','#B0A8A0','#C0A890','#83567f','#C898C0','#412642','#d4c896'],
    pinky: ['transparent','#08060d','#140616','#b67a50','#C8B070','#e8c040','#221216','#d4c896'],
    math: ['transparent','#08070f','#221216','#B09078','#C8B8A0','#655f5a','#65514b','#d4c896'],
    ...
    scrap_dog: ['transparent','#000','#331a15','#412015','#5c3a33','#987341','#d4c896','#140c16'],
    // v13 wave 8a — train hopper: faded denim jacket + gray beard + dusty backpack
    train_hopper: ['transparent','#08060d','#332e4c','#565178','#837a97','#d4c896','#33201d','#98827f'],
    // v13 wave 8a — park bench philosopher: gray hair + brown coat + kindly face
    philosopher:  ['transparent','#08060d','#543a3b','#836c68','#C8C0B8','#d4c896','#332024','#88A08C'],
    // v13 wave 8a — price guy: black coat + hat brim + a stillness about him. mostly silhouette.
    price_guy:    ['transparent','#000','#08060f','#14121e','#25222d','#d4c896','#4f2633','#d4c896'],
    lease_guy:    ['transparent','#110c11','#332628','#654f41','#927358','#d4c896','#b67339','#88C0FF'],
    gutter_greg:  ['transparent','#0d0d16','#242d32','#455650','#747360','#d4c896','#e8c040','#33201d'],
    // v19 rival courts. Slate blue avoids the bright cop-only blue language.
    blue_tarp_guard: ['transparent','#0e0f1e','#2e3a5b','#925e49','#212a42','#e8c040','#22181e','#656f7f'],
    receipt_guard: ['transparent','#130e14','#d4c896','#925e49','#4f3c3b','#792e3d','#251d20','#928370'],
    wire_guard: ['transparent','#0d080f','#41402c','#83523b','#2d1e21','#c65631','#1a121a','#792e3d'],
    darryl_under_blue: ['transparent','#090a16','#293859','#986550','#1a2237','#e8c040','#22181e','#72829f'],
    general_receipt: ['transparent','#110d14','#d4c896','#986550','#543d33','#e8c040','#2a2024','#792e3d'],
    bishop_wire: ['transparent','#09070e','#281d20','#986550','#41402c','#c65631','#1b1218','#d4c896'],
    curb_emperor: ['transparent','#08060d','#4f444a','#925e49','#792e3d','#e8c040','#151216','#c65631'],
    // v13 wave 8a — old school brutus: bigger brutus palette w/ deeper rust + darker accents
    os_brutus:    ['transparent','#000','#221216','#41201d','#543333','#15060d','#987341','#4f1a15'],
  };
  ...
  PLAYER_LAYER_PAL=['transparent','#08060d','#e8c040','#792e3d','#c65631','#d4c896','#41402c','#D488D4'];
