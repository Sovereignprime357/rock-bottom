...
export function init_constants_world() {
  ...
  // Set-back structures. Wave 4.1 makes physicality explicit: these 28 are reachable
  // architecture, not scenery. Entrance-bearing kinds share the centered south-door aperture.
  LANDMARK_FACADES = [
    { id:'checks',          x:760,  y:90,   w:200, h:170, kind:'storefront', solid:true, sign:'CHECKS' },
    { id:'rooms_no',        x:760,  y:310,  w:200, h:150, kind:'rowhouse',   solid:true, doorGap:true, sign:'ROOMS (NO)' },
    { id:'former_dentist',  x:1740, y:620,  w:300, h:140, kind:'storefront', solid:true, sign:'FORMER DENTIST' },
    { id:'boxes',           x:2340, y:90,   w:420, h:270, kind:'warehouse',  solid:true, doorGap:true, sign:'BOXES' },
    { id:'tire_2',          x:2820, y:100,  w:360, h:260, kind:'warehouse',  solid:true, doorGap:true, sign:'TIRE 2' },
    { id:'car_wash',        x:2340, y:630,  w:360, h:130, kind:'storefront', solid:true, sign:'CAR WASH · NO WATER' },
    { id:'used_mattress',   x:2780, y:620,  w:440, h:140, kind:'storefront', solid:true, sign:'USED MATTRESS' },
    { id:'motel',           x:3050, y:940,  w:190, h:390, kind:'rowhouse',   solid:true, doorGap:true, sign:'MOTEL · OFFICE CLOSED' },
    { id:'projects_a',      x:100,  y:1685, w:260, h:78,  kind:'rowhouse',   solid:true, doorGap:true, sign:'BUILDING A' },
    { id:'self_storage',    x:70,   y:2070, w:500, h:270, kind:'warehouse',  solid:true, doorGap:true, sign:'SELF STORAGE' },
    { id:'carpet',          x:900,  y:2050, w:360, h:250, kind:'warehouse',  solid:true, doorGap:true, sign:'CARPET' },
    { id:'meat',            x:1400, y:2040, w:580, h:280, kind:'industrial', solid:true, doorGap:true, sign:'MEAT' },
    { id:'loading',         x:2240, y:2290, w:940, h:160, kind:'warehouse',  solid:true, doorGap:true, sign:'LOADING' },
    { id:'no_refunds',      x:1530, y:2700, w:600, h:300, kind:'warehouse',  solid:true, doorGap:true, sign:'NO REFUNDS' },
    { id:'tax',             x:2280, y:2690, w:600, h:270, kind:'industrial', solid:true, doorGap:true, sign:'TAX' },
    { id:'unit_4',          x:3050, y:2680, w:760, h:280, kind:'warehouse',  solid:true, doorGap:true, sign:'UNIT 4' },
    { id:'cold_not',        x:4440, y:1080, w:450, h:230, kind:'warehouse',  solid:true, doorGap:true, sign:'COLD (NOT)' },
    { id:'plastic_chair',   x:5060, y:1090, w:500, h:220, kind:'warehouse',  solid:true, doorGap:true, sign:'PLASTIC CHAIR' },
    { id:'water_dry',       x:4460, y:2250, w:520, h:210, kind:'industrial', solid:true, doorGap:true, sign:'WATER DEPT. (DRY)' },
    { id:'leasing_later',   x:5180, y:2250, w:420, h:200, kind:'storefront', solid:true, sign:'LEASING · LATER' },
    { id:'tarp_wholesale',  x:5920, y:40,   w:520, h:180, kind:'warehouse',  solid:true, doorGap:true, sign:'TARP WHOLESALE' },
    { id:'family_court_2',  x:6500, y:40,   w:560, h:180, kind:'rowhouse',   solid:true, doorGap:true, sign:'FAMILY COURT 2' },
    { id:'wheel_witness',   x:7360, y:1120, w:420, h:190, kind:'warehouse',  solid:true, doorGap:true, sign:'WHEEL WITNESS' },
    { id:'coin_return',     x:7900, y:1120, w:440, h:190, kind:'storefront', solid:true, sign:'COIN RETURN' },
    { id:'wire_less',       x:5940, y:2600, w:500, h:130, kind:'industrial', solid:true, doorGap:true, sign:'WIRE (LESS)' },
    { id:'b_flat_storage',  x:6540, y:2600, w:520, h:130, kind:'warehouse',  solid:true, doorGap:true, sign:'B FLAT STORAGE' },
    { id:'chair_annex',     x:7280, y:4100, w:440, h:80,  kind:'rowhouse',   solid:true, doorGap:true, sign:'CHAIR ANNEX' },
    { id:'ditch_clerk',     x:7800, y:4100, w:520, h:80,  kind:'storefront', solid:true, sign:'DITCH CLERK' },
  ];
