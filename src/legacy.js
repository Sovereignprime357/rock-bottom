...
import { EQUIPMENT, GRAFFITI_LINES, PUBLIC_PHONE_LINES, SCRAP_GRAFFITI_LINES, SPIRITUAL_GRAFFITI_LINES, VENDOR_FLOATER_IDS, VENDOR_INDEX_META } from './data/catalogs.js';
import { clamp, currentZone, inZone, isNight, rectsOverlap, spawnCashPiles, spawnNpcs } from './data/npc_spawns.js';
...
import { possumDialogue, spawnFreedDogFollower } from './dialogue/neighborhood_a.js';
import { maybeFireFallenPriestCall, openStripePackage } from './dialogue/neighborhood_b.js';
import { giveBusPass, hasBusPass, maybeSpawnPriceGuy, tryEnterOldSchool, tryParkBenchSit } from './dialogue/vendors_places.js';
import { bailHeatMini, cookBatchMenu, drawHeatMini, drawSmokeOverlay, hasPropane, lockHeatMini, updateHeatMini } from './minigames/heat.js';
import { PALS, SPRITE_CACHE, buildSprites, parseGrid, rasterize } from './render/sprites.js';
import { CLAIM_SITES, CLAIM_SITE_BY_ID, KINGDOM_CLANS, KINGDOM_EMPEROR, OFFICE_DOOR, OFFICE_UPGRADE_DEFS, activeOfficeContract, cancelDistrictClaim, claimFileCost, claimGateReason, claimedDistrictIds, currentPrimaryObjective, ensureKingdomState, ensureOfficeState, fileDistrictClaim, fileOfficeWork, freshKingdomState, freshOfficeState, kingdomStageClan, maybeUnlockKingdom, maybeUnlockOfficeQuest, officeDailyCap, officeOwned, openKingdomLedger, purchaseOfficeUpgrade, selectDistrictClaim, startOfficeWork, syncKingdomForces, syncKingdomQuests, syncOfficeDay, tryKingdomDoor, tryUseKingdomTarget, tryUseOfficeFieldTarget, updateGuidance, updateKingdomBattle, updateOfficeMilestones } from './systems/campaigns.js';
import { aggroNpc, completeIntroSmoke, damagePlayer, die, manageCops, onNpcDeath, playerAttack, questToast, spawnProjectile, tryCompleteIntroRemember } from './systems/combat.js';
import { broadcastNews, feedPost, fireMomIntroTipOnce, fireRandomEvent, garbageTruckRumble, maybeFireMomProudCall, phoneState, renderPhone, ringPhone, rotateNews } from './systems/communications.js';
