...
import { H, LANDMARK_FACADES, RAIL_LINES, RANKS, ROAD_SEGMENTS, TERRAIN_REGIONS, TILE, W, WORLD, WORLD_LIGHTS, ZONES } from './data/world.js';
...
import { FOG_SHEET, LIGHT_CTX, LIGHT_GLOW_CACHE, LIGHT_MASK, buildFogSheet, buildLandmarkFacades, buildLightSprites, drawForegroundWorld, drawKingdomSites, drawLandmarkFacades, drawWorldDecor, nightAmount, punchLightMask } from './render/landmarks_a.js';
