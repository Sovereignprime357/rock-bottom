 ...
 * Source seams: game start and new-game initialization | cache and HUD boot sequence | mobile controls and final startup.
 * Do not hand-edit; change the source module after the refactor lands.
 */
import { SAVE_KEY, audio, loadGame, saveGame } from './core/audio_save.js';
import { P, applyEquipStats, renderQuests, runtime, state, toast } from './core/runtime_ui.js';
...
import { INPUT_RELEASE_HOOKS, continueAfterEnding, loadFromTitle, releaseAllInput } from './input/keyboard.js';
...
import { broadcastNews, feedPost, rotateNews } from './systems/communications.js';
