...
import { H, LANDMARK_FACADES, RAIL_LINES, RANKS, ROAD_SEGMENTS, TERRAIN_REGIONS, TILE, UTILITY_WIRES, W, WORLD, WORLD_DECOR, WORLD_LIGHTS, ZONES } from './data/world.js';
...
import { bailHeatMini, cookBatchMenu, drawHeatMini, drawSmokeOverlay, hasPropane, lockHeatMini } from './minigames/heat.js';
import { ENV_SPRITE_CACHE, buildEnvironmentSprites, ctx, drawWorldFabric, visibleWorldRect } from './render/canvas_geography.js';
import { PALS, SPRITE_CACHE, buildSprites } from './render/sprites.js';
import { CLAIM_SITES, CLAIM_SITE_BY_ID, KINGDOM_CLANS, KINGDOM_EMPEROR, OFFICE_DOOR, OFFICE_UPGRADE_DEFS, activeOfficeContract, cancelDistrictClaim, claimFileCost, claimGateReason, claimedDistrictIds, currentPrimaryObjective, ensureKingdomState, ensureOfficeState, fileDistrictClaim, fileOfficeWork, freshKingdomState, freshOfficeState, kingdomStageClan, maybeUnlockKingdom, maybeUnlockOfficeQuest, officeDailyCap, officeOwned, openKingdomLedger, purchaseOfficeUpgrade, selectDistrictClaim, startOfficeWork, syncKingdomForces, syncKingdomQuests, syncOfficeDay, tryKingdomDoor, tryUseKingdomTarget, tryUseOfficeFieldTarget, updateOfficeMilestones } from './systems/campaigns.js';
...
import { drawIncidentPlayerCosmetics, drawIncidents, startIncident, updateActiveIncident } from './systems/incidents.js';
