...
- [ ] **Operator play gate.** THE FLAGGED FORK: the crowbar shares the tool slot with the torch (real carry choice, swap free at pete). Redirect if you'd rather they stack. Also yours: walk the quarter and see if three buildings read as a reason to go; judge whether the goose is funny; tune $35 / cap 2 / cred 25 & 50 if the pacing reads wrong.
