...
| **5.6** | **Fill the barren quarter** | ⛔ BLOCKED by 5.5's merge | ~25% of the map is empty. 5.5 built the reason to go there (break-in targets) and the pattern 5.6 inherits: sites are data, doors are gates, one engine. Unblocks when the operator merges. Density, not distance. |
